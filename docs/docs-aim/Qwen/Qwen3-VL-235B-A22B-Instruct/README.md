...
This AIM allows to deploy Qwen/Qwen3-VL-235B-A22B-Instruct with a tailored set of profiles.

* Model name: Qwen/Qwen3-VL-235B-A22B-Instruct
* Description: 236B parameter MoE vision-language model with 22B active parameters and multimodal capabilities.
* Capabilities:
  * image-to-text
  * vision-language
  * multimodal
