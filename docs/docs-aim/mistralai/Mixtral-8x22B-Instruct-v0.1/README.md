...
This AIM allows to deploy mistralai/Mixtral-8x22B-Instruct-v0.1 with a tailored set of profiles.

* Model name: mistralai/Mixtral-8x22B-Instruct-v0.1
* Description: Sparse MoE language model with 141B total parameters across 8 experts and function calling support.
* Capabilities:
  * text-generation
  * chat
  * instruction
...
|vllm-mi300x-fp16-tp8-latency|MI300X|fp16|vllm|8|latency|preview|False|
...
|vllm-mi350x-fp16-tp4-throughput|MI350X|fp16|vllm|4|throughput|optimized|False|
...
|vllm-mi355x-fp16-tp4-throughput|MI355X|fp16|vllm|4|throughput|optimized|False|
