...
This AIM allows to deploy mistralai/Ministral-3-14B-Reasoning-2512 with a tailored set of profiles.

* Model name: mistralai/Ministral-3-14B-Reasoning-2512
* Description: 14B parameter instruction-tuned language model with vision and function calling capabilities.
* Capabilities:
  * multilingual
  * text-generation
  * vision
