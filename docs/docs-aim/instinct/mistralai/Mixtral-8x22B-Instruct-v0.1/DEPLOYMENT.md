...
This guide provides step-by-step instructions for deploying AMD Inference Microservice (AIM) container for
 mistralai/Mixtral-8x22B-Instruct-v0.1 model in
...
docker run \
  ...
  -p 8000:8000 \
  amdenterpriseai/aim-mistralai-mixtral-8x22b-instruct-v0-1:0.11.1
```
...
docker run --rm \
  ...
  amdenterpriseai/aim-mistralai-mixtral-8x22b-instruct-v0-1:0.11.1 \
  download-to-cache --model-id mistralai/Mixtral-8x22B-Instruct-v0.1
```
...
spec:
  ...
  template:
    ...
    spec:
      containers:
        - name: minimal-aim-deployment
          image: amdenterpriseai/aim-mistralai-mixtral-8x22b-instruct-v0-1:0.11.1
...
aim_id: mistralai/Mixtral-8x22B-Instruct-v0.1
