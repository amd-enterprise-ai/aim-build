...
This AIM allows to deploy Qwen/Qwen3-VL-8B-Instruct with a tailored set of profiles.

* Model name: Qwen/Qwen3-VL-8B-Instruct
* Description: 8B parameter vision-language model with advanced multimodal reasoning.
* Capabilities:
  * text-generation
  * chat
  * vision
