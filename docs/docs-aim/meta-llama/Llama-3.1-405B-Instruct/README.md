...
|vllm-mi300x-fp16-tp8-latency|MI300X|fp16|vllm|8|latency|unoptimized|
|vllm-mi300x-fp16-tp8-throughput|MI300X|fp16|vllm|8|throughput|unoptimized|
|vllm-mi300x-fp8-tp4-latency|MI300X|fp8|vllm|4|latency|unoptimized|
|vllm-mi300x-fp8-tp4-throughput|MI300X|fp8|vllm|4|throughput|unoptimized|
...
|vllm-mi325x-fp8-tp4-latency|MI325X|fp8|vllm|4|latency|unoptimized|
|vllm-mi325x-fp8-tp4-throughput|MI325X|fp8|vllm|4|throughput|unoptimized|
|vllm-mi325x-fp8-tp8-latency|MI325X|fp8|vllm|8|latency|unoptimized|
|vllm-mi325x-fp8-tp8-throughput|MI325X|fp8|vllm|8|throughput|unoptimized|
