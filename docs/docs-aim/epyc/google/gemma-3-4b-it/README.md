...
This AIM allows to deploy google/gemma-3-4b-it with a tailored set of profiles.

* Model name: google/gemma-3-4b-it
* Description: Gemma 3 4B Instruct multimodal model from Google DeepMind.
* Capabilities:
  * text-generation
  * instruction
  * image-text-to-text
...
This AIM can be used in accordance with the following licenses: gemma, Apache-2.0.
