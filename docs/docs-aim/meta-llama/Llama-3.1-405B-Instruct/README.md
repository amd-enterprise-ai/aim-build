...
This AIM allows to deploy meta-llama/Llama-3.1-405B-Instruct with a tailored set of profiles.

* Model name: meta-llama/Llama-3.1-405B-Instruct
* Description: Multilingual 405B parameter instruction-tuned language model for dialogue use cases.
* Capabilities:
  * text-generation
  * chat
  * instruction
...
|-------|---|---------|------|---------|------|----|-------------|
|vllm-mi300x-fp16-tp8-latency|MI300X|fp16|vllm|8|latency|optimized|False|
|vllm-mi300x-fp16-tp8-throughput|MI300X|fp16|vllm|8|throughput|optimized|False|
|vllm-mi300x-fp8-tp4-latency|MI300X|fp8|vllm|4|latency|unoptimized|True|
|vllm-mi300x-fp8-tp4-throughput|MI300X|fp8|vllm|4|throughput|unoptimized|True|
|vllm-mi300x-fp8-tp8-latency|MI300X|fp8|vllm|8|latency|unoptimized|True|
|vllm-mi300x-fp8-tp8-throughput|MI300X|fp8|vllm|8|throughput|unoptimized|True|
|vllm-mi325x-fp16-tp8-latency|MI325X|fp16|vllm|8|latency|unoptimized|True|
|vllm-mi325x-fp16-tp8-throughput|MI325X|fp16|vllm|8|throughput|unoptimized|True|
...
|vllm-mi350x-fp16-tp8-latency|MI350X|fp16|vllm|8|latency|preview|False|
...
|vllm-mi350x-mxfp4-tp8-latency|MI350X|fp4|vllm|8|latency|unoptimized|True|
|vllm-mi350x-mxfp4-tp8-throughput|MI350X|fp4|vllm|8|throughput|preview|False|
|vllm-mi355x-fp16-tp8-latency|MI355X|fp16|vllm|8|latency|preview|False|
...
|vllm-mi355x-mxfp4-tp4-throughput|MI355X|fp4|vllm|4|throughput|unoptimized|True|
|vllm-mi355x-mxfp4-tp8-latency|MI355X|fp4|vllm|8|latency|unoptimized|True|
|vllm-mi355x-mxfp4-tp8-throughput|MI355X|fp4|vllm|8|throughput|preview|False|
...
This AIM can be used in accordance with the following licenses: llama3.1, MIT.
