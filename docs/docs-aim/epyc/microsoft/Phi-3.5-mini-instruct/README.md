...
This AIM allows to deploy microsoft/Phi-3.5-mini-instruct with a tailored set of profiles.

* Model name: microsoft/Phi-3.5-mini-instruct
* Description: 3.8B parameter language model optimized for reasoning, math, and code tasks in memory-constrained environments.
* Capabilities:
  * text-generation
  * chat
  * instruction
