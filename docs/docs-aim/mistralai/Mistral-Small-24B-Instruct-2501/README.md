...
This AIM allows to deploy mistralai/Mistral-Small-24B-Instruct-2501 with a tailored set of profiles.

* Model name: mistralai/Mistral-Small-24B-Instruct-2501
* Description: 24B parameter instruction-tuned language model (Mistral Small 3) with native function calling. Text-only.
* Capabilities:
  * text-generation
  * chat
