...
This AIM allows to deploy deepseek-ai/DeepSeek-V3.1 with a tailored set of profiles.

* Model name: deepseek-ai/DeepSeek-V3.1
* Description: 671B parameter MoE model with 37B active parameters supporting thinking and non-thinking modes.
* Capabilities:
  * text-generation
  * chat
