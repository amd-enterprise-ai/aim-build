...
This AIM allows to deploy MiniMaxAI/MiniMax-M3 with a tailored set of profiles.

* Model name: MiniMaxAI/MiniMax-M3
* Description: Native multimodal MoE model with 428B parameters, 23B active parameters, a 1M-token context window, reasoning, tool use, and coding capabilities.
* Capabilities:
  * text-generation
  * image-text-to-text
  * chat
...
|-------|-------------------|---------|------|---------|------|----|
|vllm-mi300x-fp8-tp8-latency|MI300X|fp8|vllm|8|latency|optimized|
|vllm-mi300x-fp8-tp8-throughput|MI300X|fp8|vllm|8|throughput|optimized|
|vllm-mi325x-fp8-tp4-latency|MI325X|fp8|vllm|4|latency|optimized|
|vllm-mi325x-fp8-tp4-throughput|MI325X|fp8|vllm|4|throughput|optimized|
|vllm-mi325x-fp8-tp8-latency|MI325X|fp8|vllm|8|latency|optimized|
|vllm-mi325x-fp8-tp8-throughput|MI325X|fp8|vllm|8|throughput|optimized|
|vllm-mi350x-fp8-tp4-latency|MI350X|fp8|vllm|4|latency|optimized|
|vllm-mi350x-fp8-tp4-throughput|MI350X|fp8|vllm|4|throughput|optimized|
|vllm-mi350x-fp8-tp8-latency|MI350X|fp8|vllm|8|latency|optimized|
|vllm-mi350x-fp8-tp8-throughput|MI350X|fp8|vllm|8|throughput|optimized|
|vllm-mi355x-fp8-tp4-latency|MI355X|fp8|vllm|4|latency|optimized|
|vllm-mi355x-fp8-tp4-throughput|MI355X|fp8|vllm|4|throughput|optimized|
|vllm-mi355x-fp8-tp8-latency|MI355X|fp8|vllm|8|latency|optimized|
|vllm-mi355x-fp8-tp8-throughput|MI355X|fp8|vllm|8|throughput|optimized|
...
This AIM can be used in accordance with the following licenses: MiniMax Community License, MIT.
