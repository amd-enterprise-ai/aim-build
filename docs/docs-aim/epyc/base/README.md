...
|-------|-------------------|---------|------|---------|------|----|-------------|
|vllm-epyc_9965-bf16-tp1-latency|EPYC_9965|bf16|vllm|188|latency|general|False|
|vllm-epyc_zen4-bf16-tp1-latency|EPYC_ZEN4|bf16|vllm|92|latency|general|False|
|vllm-epyc_zen5-bf16-tp1-latency|EPYC_ZEN5|bf16|vllm|124|latency|general|False|
