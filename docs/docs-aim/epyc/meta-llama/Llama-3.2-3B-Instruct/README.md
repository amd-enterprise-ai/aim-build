...
This AIM allows to deploy meta-llama/Llama-3.2-3B-Instruct with a tailored set of profiles.

* Model name: meta-llama/Llama-3.2-3B-Instruct
* Description: Multilingual 3B parameter instruction-tuned language model for dialogue and on-device use cases.
* Capabilities:
  * text-generation
  * chat
  * instruction
...
|-------|-------------------|---------|------|---------|------|----|-------------|
|vllm-epyc_9965-bf16-tp1-latency|EPYC_9965|bf16|vllm|188|latency|preview|False|
|vllm-epyc_9965-bf16-tp1-throughput|EPYC_9965|bf16|vllm|188|throughput|preview|False|
|vllm-epyc_zen4-bf16-tp1-latency|EPYC_ZEN4|bf16|vllm|92|latency|unoptimized|True|
|vllm-epyc_zen4-bf16-tp1-throughput|EPYC_ZEN4|bf16|vllm|92|throughput|unoptimized|True|
|vllm-epyc_zen5-bf16-tp1-latency|EPYC_ZEN5|bf16|vllm|124|latency|unoptimized|True|
|vllm-epyc_zen5-bf16-tp1-throughput|EPYC_ZEN5|bf16|vllm|124|throughput|unoptimized|True|
...
This AIM can be used in accordance with the following licenses: llama3.2, MIT, AMD EPYC CONTAINER LICENSE AGREEMENT.
