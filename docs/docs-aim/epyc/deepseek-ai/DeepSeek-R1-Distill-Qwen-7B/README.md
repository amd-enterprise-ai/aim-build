...
This AIM allows to deploy deepseek-ai/DeepSeek-R1-Distill-Qwen-7B with a tailored set of profiles.

* Model name: deepseek-ai/DeepSeek-R1-Distill-Qwen-7B
* Description: 7B parameter distilled reasoning model based on Qwen-2.5, optimized for CPU inference on AMD EPYC.
* Capabilities:
  * text-generation
  * reasoning
  * chat
