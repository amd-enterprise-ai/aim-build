...
This guide provides step-by-step instructions for deploying AMD Inference Microservice (AIM) container for
 meta-llama/Llama-3.1-8B-Instruct model in
...
docker run \
  ...
  -p 8000:8000 \
  amdenterpriseai/aim-epyc-meta-llama-llama-3-1-8b-instruct:0.13.0
```
...
spec:
  ...
  template:
    ...
    spec:
      containers:
        - name: minimal-aim-deployment
          image: amdenterpriseai/aim-epyc-meta-llama-llama-3-1-8b-instruct:0.13.0
