...
This AIM allows to deploy Qwen/Qwen3-32B with a tailored set of profiles.

* Model name: Qwen/Qwen3-32B
* Description: 32.8B parameter dense language model with dual thinking modes and multilingual support.
* Capabilities:
  * text-generation
  * chat
...
|vllm-mi300x-bf16-tp2-latency|MI300X|bf16|vllm|2|latency|optimized|False|
|vllm-mi300x-bf16-tp2-throughput|MI300X|bf16|vllm|2|throughput|optimized|False|
...
|vllm-mi350x-bf16-tp1-latency|MI350X|bf16|vllm|1|latency|unoptimized|True|
|vllm-mi350x-bf16-tp1-throughput|MI350X|bf16|vllm|1|throughput|unoptimized|True|
|vllm-mi350x-bf16-tp2-latency|MI350X|bf16|vllm|2|latency|unoptimized|True|
|vllm-mi350x-bf16-tp2-throughput|MI350X|bf16|vllm|2|throughput|unoptimized|True|
|vllm-mi350x-fp8-tp1-latency|MI350X|fp8|vllm|1|latency|unoptimized|True|
|vllm-mi350x-fp8-tp1-throughput|MI350X|fp8|vllm|1|throughput|unoptimized|True|
|vllm-mi350x-fp8-tp2-latency|MI350X|fp8|vllm|2|latency|preview|False|
|vllm-mi350x-fp8-tp2-throughput|MI350X|fp8|vllm|2|throughput|unoptimized|True|
|vllm-mi355x-bf16-tp1-latency|MI355X|bf16|vllm|1|latency|unoptimized|True|
|vllm-mi355x-bf16-tp1-throughput|MI355X|bf16|vllm|1|throughput|unoptimized|True|
|vllm-mi355x-bf16-tp2-latency|MI355X|bf16|vllm|2|latency|unoptimized|True|
|vllm-mi355x-bf16-tp2-throughput|MI355X|bf16|vllm|2|throughput|unoptimized|True|
|vllm-mi355x-fp8-tp1-latency|MI355X|fp8|vllm|1|latency|unoptimized|True|
|vllm-mi355x-fp8-tp1-throughput|MI355X|fp8|vllm|1|throughput|unoptimized|True|
