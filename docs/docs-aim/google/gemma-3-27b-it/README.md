...
This AIM allows to deploy google/gemma-3-27b-it with a tailored set of profiles.

* Model name: google/gemma-3-27b-it
* Description: Gemma 3 27B IT is a multimodal instruction-tuned model supporting text and image input with a 128K context window.
* Capabilities:
  * text-generation
  * image-text-to-text
  * chat
...
This AIM can be used in accordance with the following licenses: gemma, MIT.
