...
This AIM allows to deploy mistralai/Mixtral-8x7B-Instruct-v0.1 with a tailored set of profiles.

* Model name: mistralai/Mixtral-8x7B-Instruct-v0.1
* Description: Sparse MoE language model with 47B total parameters across 8 experts.
* Capabilities:
  * text-generation
  * chat
