...
This AIM allows to deploy zai-org/GLM-4.7-Flash with a tailored set of profiles.

* Model name: zai-org/GLM-4.7-Flash
* Description: 30B-A3B MoE language model with balanced performance and efficiency for lightweight deployment.
* Capabilities:
  * text-generation
  * chat
...
|-------|-------------------|---------|------|---------|------|----|-------------|
|vllm-r9700-bf16-tp4-latency|R9700|bf16|vllm|4|latency|preview|False|
|vllm-r9700-bf16-tp4-throughput|R9700|bf16|vllm|4|throughput|preview|False|
|vllm-w7900-bf16-tp2-latency|W7900|bf16|vllm|2|latency|preview|False|
|vllm-w7900-bf16-tp2-throughput|W7900|bf16|vllm|2|throughput|preview|False|
