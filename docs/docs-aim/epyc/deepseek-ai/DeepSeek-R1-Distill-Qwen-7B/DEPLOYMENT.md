...
This guide provides step-by-step instructions for deploying AMD Inference Microservice (AIM) container for
 deepseek-ai/DeepSeek-R1-Distill-Qwen-7B model in
...
docker run \
  -p 8000:8000 \
  amdenterpriseai/aim-epyc-deepseek-ai-deepseek-r1-distill-qwen-7b:0.13.0
```
...
docker run --rm \
  ...
  amdenterpriseai/aim-epyc-deepseek-ai-deepseek-r1-distill-qwen-7b:0.13.0 \
  download-to-cache --model-id deepseek-ai/DeepSeek-R1-Distill-Qwen-7B
```
...
spec:
  ...
  template:
    ...
    spec:
      containers:
        - name: minimal-aim-deployment
          image: amdenterpriseai/aim-epyc-deepseek-ai-deepseek-r1-distill-qwen-7b:0.13.0
...
aim_id: deepseek-ai/DeepSeek-R1-Distill-Qwen-7B
