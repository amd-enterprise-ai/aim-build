...
This AIM allows to deploy Qwen/Qwen3-4B with a tailored set of profiles.

* Model name: Qwen/Qwen3-4B
* Description: Reasoning-enhanced 4B parameter LLM with thinking/non-thinking mode switching, excelling in math, coding, and multi-turn conversations.
* Capabilities:
  * text-generation
  * chat
  * reasoning
