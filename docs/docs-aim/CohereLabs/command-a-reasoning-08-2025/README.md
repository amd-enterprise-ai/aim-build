...
|-------|---|---------|------|---------|------|----|-------------|
|vllm-mi250x-fp16-tp8-latency|MI250X|fp16|vllm|8|latency|unoptimized|True|
|vllm-mi250x-fp16-tp8-throughput|MI250X|fp16|vllm|8|throughput|unoptimized|True|
...
|vllm-mi300x-fp16-tp4-throughput|MI300X|fp16|vllm|4|throughput|preview|False|
...
|vllm-mi350x-fp16-tp4-latency|MI350X|fp16|vllm|4|latency|preview|False|
...
|vllm-mi355x-fp16-tp8-throughput|MI355X|fp16|vllm|8|throughput|unoptimized|True|
