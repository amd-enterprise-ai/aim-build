...
This AIM allows to deploy Qwen/Qwen2.5-Coder-7B-Instruct with a tailored set of profiles.

* Model name: Qwen/Qwen2.5-Coder-7B-Instruct
* Description: 7B parameter coding and instruction-following model optimized for CPU inference on AMD EPYC.
* Capabilities:
  * text-generation
  * code-generation
  * code-completion
