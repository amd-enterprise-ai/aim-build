...
docker run \
  ...
  -p 8000:8000 \
  amdenterpriseai/aim-radeon-meta-llama-llama-3-1-8b-instruct:0.12.0-preview
```
...
spec:
  ...
  template:
    ...
    spec:
      containers:
        - name: minimal-aim-deployment
          image: amdenterpriseai/aim-radeon-meta-llama-llama-3-1-8b-instruct:0.12.0-preview
