...
|-------|---|---------|------|---------|------|----|
|vllm-mi300x-fp16-tp1-latency|MI300X|fp16|vllm|1|latency|optimized|
|vllm-mi300x-fp16-tp1-throughput|MI300X|fp16|vllm|1|throughput|optimized|
|vllm-mi300x-fp16-tp2-latency|MI300X|fp16|vllm|2|latency|unoptimized|
|vllm-mi300x-fp16-tp2-throughput|MI300X|fp16|vllm|2|throughput|optimized|
|vllm-mi300x-fp8-tp1-latency|MI300X|fp8|vllm|1|latency|optimized|
|vllm-mi300x-fp8-tp1-throughput|MI300X|fp8|vllm|1|throughput|optimized|
|vllm-mi300x-fp8-tp2-latency|MI300X|fp8|vllm|2|latency|optimized|
|vllm-mi300x-fp8-tp2-throughput|MI300X|fp8|vllm|2|throughput|optimized|
