...
This AIM allows to deploy mistralai/Mistral-Large-3-675B-Instruct-2512 with a tailored set of profiles.

* Model name: mistralai/Mistral-Large-3-675B-Instruct-2512
* Description: 675B parameter granular MoE multimodal model with 41B active parameters and vision capabilities.
* Capabilities:
  * text-generation
  * chat
  * multilingual
