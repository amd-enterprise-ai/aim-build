...
This AIM allows to deploy Qwen/Qwen3-0.6B with a tailored set of profiles.

* Model name: Qwen/Qwen3-0.6B
* Description: Reasoning-enhanced 0.6B parameter LLM with thinking/non-thinking mode switching, excelling in math, coding, and multi-turn conversations.
* Capabilities:
  * text-generation
  * chat
  * reasoning
...
|-------|-------------------|---------|------|---------|------|----|
|vllm-epyc_9965-bf16-tp1-latency|EPYC_9965|bf16|vllm|188|latency|unoptimized|
