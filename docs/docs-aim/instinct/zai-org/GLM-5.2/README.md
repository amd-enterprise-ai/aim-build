...
This AIM allows to deploy zai-org/GLM-5.2 with a tailored set of profiles.

* Model name: zai-org/GLM-5.2
* Description: GLM-5.2 is a large Mixture-of-Experts language model with multi-turn conversation, tool use, and reasoning capabilities.
* Capabilities:
  * text-generation
  * chat
  * reasoning
