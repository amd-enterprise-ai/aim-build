...
This AIM allows to deploy Qwen/Qwen3-8B with a tailored set of profiles.

* Model name: Qwen/Qwen3-8B
* Description: Reasoning-enhanced 8B parameter LLM with thinking/non-thinking mode switching, excelling in math, coding, and multi-turn conversations.
* Capabilities:
  * text-generation
  * chat
  * reasoning
