...
This AIM allows to deploy google/gemma-4-31B-it with a tailored set of profiles.

* Model name: google/gemma-4-31B-it
* Description: Gemma 4 31B IT is a multimodal instruction-tuned model with text and image input, 256K native context, and Gemma 4 reasoning + tool-call parsers.
* Capabilities:
  * text-generation
  * image-text-to-text
  * chat
...
|-------|---|---------|------|---------|------|----|-------------|
|vllm-mi300x-bf16-tp1-latency|MI300X|bf16|vllm|1|latency|optimized|False|
|vllm-mi300x-bf16-tp1-throughput|MI300X|bf16|vllm|1|throughput|optimized|False|
|vllm-mi300x-bf16-tp2-latency|MI300X|bf16|vllm|2|latency|preview|False|
|vllm-mi300x-bf16-tp2-throughput|MI300X|bf16|vllm|2|throughput|preview|False|
|vllm-mi300x-bf16-tp4-latency|MI300X|bf16|vllm|4|latency|preview|False|
|vllm-mi300x-bf16-tp4-throughput|MI300X|bf16|vllm|4|throughput|preview|False|
|vllm-mi300x-bf16-tp8-latency|MI300X|bf16|vllm|8|latency|optimized|False|
|vllm-mi300x-bf16-tp8-throughput|MI300X|bf16|vllm|8|throughput|optimized|False|
|vllm-mi325x-bf16-tp1-latency|MI325X|bf16|vllm|1|latency|unoptimized|True|
|vllm-mi325x-bf16-tp1-throughput|MI325X|bf16|vllm|1|throughput|unoptimized|True|
|vllm-mi325x-bf16-tp2-latency|MI325X|bf16|vllm|2|latency|unoptimized|True|
|vllm-mi325x-bf16-tp2-throughput|MI325X|bf16|vllm|2|throughput|unoptimized|True|
|vllm-mi325x-bf16-tp4-latency|MI325X|bf16|vllm|4|latency|unoptimized|True|
|vllm-mi325x-bf16-tp4-throughput|MI325X|bf16|vllm|4|throughput|unoptimized|True|
|vllm-mi325x-bf16-tp8-latency|MI325X|bf16|vllm|8|latency|unoptimized|True|
|vllm-mi325x-bf16-tp8-throughput|MI325X|bf16|vllm|8|throughput|unoptimized|True|
|vllm-mi350x-bf16-tp1-latency|MI350X|bf16|vllm|1|latency|optimized|False|
|vllm-mi350x-bf16-tp1-throughput|MI350X|bf16|vllm|1|throughput|preview|False|
|vllm-mi350x-bf16-tp2-latency|MI350X|bf16|vllm|2|latency|optimized|False|
|vllm-mi350x-bf16-tp2-throughput|MI350X|bf16|vllm|2|throughput|optimized|False|
|vllm-mi350x-bf16-tp4-latency|MI350X|bf16|vllm|4|latency|optimized|False|
|vllm-mi350x-bf16-tp4-throughput|MI350X|bf16|vllm|4|throughput|unoptimized|True|
|vllm-mi350x-bf16-tp8-latency|MI350X|bf16|vllm|8|latency|optimized|False|
|vllm-mi350x-bf16-tp8-throughput|MI350X|bf16|vllm|8|throughput|optimized|False|
...
|vllm-mi355x-bf16-tp2-latency|MI355X|bf16|vllm|2|latency|optimized|False|
|vllm-mi355x-bf16-tp2-throughput|MI355X|bf16|vllm|2|throughput|optimized|False|
|vllm-mi355x-bf16-tp4-latency|MI355X|bf16|vllm|4|latency|optimized|False|
|vllm-mi355x-bf16-tp4-throughput|MI355X|bf16|vllm|4|throughput|unoptimized|True|
|vllm-mi355x-bf16-tp8-latency|MI355X|bf16|vllm|8|latency|optimized|False|
|vllm-mi355x-bf16-tp8-throughput|MI355X|bf16|vllm|8|throughput|optimized|False|
