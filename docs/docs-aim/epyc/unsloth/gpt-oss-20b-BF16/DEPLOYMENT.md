...
docker run \
  -p 8000:8000 \
  amdenterpriseai/aim-epyc-unsloth-gpt-oss-20b-bf16:0.13.0
```
...
docker run --rm \
  ...
  amdenterpriseai/aim-epyc-unsloth-gpt-oss-20b-bf16:0.13.0 \
  download-to-cache --model-id unsloth/gpt-oss-20b-BF16
```
...
spec:
  ...
  template:
    ...
    spec:
      containers:
        - name: minimal-aim-deployment
          image: amdenterpriseai/aim-epyc-unsloth-gpt-oss-20b-bf16:0.13.0
...
aim_id: unsloth/gpt-oss-20b-BF16
