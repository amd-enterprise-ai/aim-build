...
This AIM allows to deploy google/medgemma-27b-it with a tailored set of profiles.

* Model name: google/medgemma-27b-it
* Description: Gemma 3-based 27B multimodal model fine-tuned for medical text and image tasks (X-ray, dermatology, ophthalmology, pathology, radiology reports).
* Capabilities:
  * text-generation
  * image-text-to-text
  * chat
...
This AIM can be used in accordance with the following licenses: HAI-DEF, MIT.
