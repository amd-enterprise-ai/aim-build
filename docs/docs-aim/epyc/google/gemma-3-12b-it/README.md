...
This AIM allows to deploy google/gemma-3-12b-it with a tailored set of profiles.

* Model name: google/gemma-3-12b-it
* Description: Gemma 3 12B Instruct multimodal model from Google DeepMind.
* Capabilities:
  * text-generation
  * instruction
  * image-text-to-text
...
|-------|-------------------|---------|------|---------|------|----|
|vllm-epyc_9965-bf16-tp1-latency|EPYC_9965|bf16|vllm|188|latency|optimized|
|vllm-epyc_9965-bf16-tp1-throughput|EPYC_9965|bf16|vllm|188|throughput|optimized|
...
This AIM can be used in accordance with the following licenses: MIT, AMD EPYC CONTAINER LICENSE AGREEMENT.
