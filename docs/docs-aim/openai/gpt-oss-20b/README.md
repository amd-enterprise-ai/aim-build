...
This AIM allows to deploy openai/gpt-oss-20b with a tailored set of profiles.
...
|vllm-mi250x-mxfp4-tp1-latency|MI250X|fp4|vllm|1|latency|unoptimized|
|vllm-mi250x-mxfp4-tp1-throughput|MI250X|fp4|vllm|1|throughput|unoptimized|
|vllm-mi250x-mxfp4-tp2-latency|MI250X|fp4|vllm|2|latency|unoptimized|
|vllm-mi250x-mxfp4-tp2-throughput|MI250X|fp4|vllm|2|throughput|unoptimized|
|vllm-mi250x-mxfp4-tp4-latency|MI250X|fp4|vllm|4|latency|unoptimized|
|vllm-mi250x-mxfp4-tp4-throughput|MI250X|fp4|vllm|4|throughput|unoptimized|
|vllm-mi250x-mxfp4-tp8-latency|MI250X|fp4|vllm|8|latency|unoptimized|
|vllm-mi250x-mxfp4-tp8-throughput|MI250X|fp4|vllm|8|throughput|unoptimized|
|vllm-mi300x-mxfp4-tp1-latency|MI300X|fp4|vllm|1|latency|optimized|
|vllm-mi300x-mxfp4-tp1-throughput|MI300X|fp4|vllm|1|throughput|optimized|
|vllm-mi300x-mxfp4-tp2-latency|MI300X|fp4|vllm|2|latency|optimized|
|vllm-mi300x-mxfp4-tp2-throughput|MI300X|fp4|vllm|2|throughput|optimized|
|vllm-mi300x-mxfp4-tp4-latency|MI300X|fp4|vllm|4|latency|optimized|
|vllm-mi300x-mxfp4-tp4-throughput|MI300X|fp4|vllm|4|throughput|optimized|
|vllm-mi300x-mxfp4-tp8-latency|MI300X|fp4|vllm|8|latency|unoptimized|
|vllm-mi300x-mxfp4-tp8-throughput|MI300X|fp4|vllm|8|throughput|optimized|
|vllm-mi325x-mxfp4-tp1-latency|MI325X|fp4|vllm|1|latency|unoptimized|
|vllm-mi325x-mxfp4-tp1-throughput|MI325X|fp4|vllm|1|throughput|unoptimized|
|vllm-mi325x-mxfp4-tp2-latency|MI325X|fp4|vllm|2|latency|unoptimized|
|vllm-mi325x-mxfp4-tp2-throughput|MI325X|fp4|vllm|2|throughput|unoptimized|
|vllm-mi325x-mxfp4-tp4-latency|MI325X|fp4|vllm|4|latency|unoptimized|
|vllm-mi325x-mxfp4-tp4-throughput|MI325X|fp4|vllm|4|throughput|unoptimized|
|vllm-mi325x-mxfp4-tp8-latency|MI325X|fp4|vllm|8|latency|unoptimized|
|vllm-mi325x-mxfp4-tp8-throughput|MI325X|fp4|vllm|8|throughput|unoptimized|
