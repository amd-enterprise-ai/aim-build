...
This AIM allows to deploy ibm-granite/granite-4.1-3b with a tailored set of profiles.

* Model name: ibm-granite/granite-4.1-3b
* Description: 3B parameter long-context instruct model with 131K context length and enhanced capabilities for summarization, RAG, and code tasks.
* Capabilities:
  * text-generation
  * chat
  * reasoning
