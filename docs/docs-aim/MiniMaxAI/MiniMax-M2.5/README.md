...
This AIM allows to deploy MiniMaxAI/MiniMax-M2.5 with a tailored set of profiles.

* Model name: MiniMaxAI/MiniMax-M2.5
* Description: 228B parameter mixture-of-experts language model with reasoning, tool calling, and coding capabilities.
* Capabilities:
  * text-generation
  * chat
  * reasoning
...
This AIM can be used in accordance with the following licenses: MiniMax-M2.5-Open, MIT.
