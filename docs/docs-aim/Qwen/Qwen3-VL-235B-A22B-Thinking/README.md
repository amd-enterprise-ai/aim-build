...
This AIM allows to deploy Qwen/Qwen3-VL-235B-A22B-Thinking with a tailored set of profiles.

* Model name: Qwen/Qwen3-VL-235B-A22B-Thinking
* Description: 236B parameter MoE vision-language model with reasoning-enhanced thinking capabilities.
* Capabilities:
  * image-to-text
  * vision-language
  * multimodal
...
|-------|---|---------|------|---------|------|----|-------------|
|vllm-mi300x-fp16-tp4-latency|MI300X|fp16|vllm|4|latency|optimized|False|
|vllm-mi300x-fp16-tp4-throughput|MI300X|fp16|vllm|4|throughput|optimized|False|
...
|vllm-mi350x-fp16-tp8-throughput|MI350X|fp16|vllm|8|throughput|optimized|False|
...
|vllm-mi350x-fp8-tp8-throughput|MI350X|fp8|vllm|8|throughput|preview|False|
...
|vllm-mi355x-fp16-tp4-latency|MI355X|fp16|vllm|4|latency|optimized|False|
...
|vllm-mi355x-fp16-tp8-throughput|MI355X|fp16|vllm|8|throughput|optimized|False|
...
|vllm-mi355x-fp8-tp8-throughput|MI355X|fp8|vllm|8|throughput|preview|False|
...
This AIM can be used in accordance with the following licenses: Apache-2.0.
