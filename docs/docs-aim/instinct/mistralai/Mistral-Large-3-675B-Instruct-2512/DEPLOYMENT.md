...
This guide provides step-by-step instructions for deploying AMD Inference Microservice (AIM) container for
 mistralai/Mistral-Large-3-675B-Instruct-2512 model in
...
docker run \
  ...
  -p 8000:8000 \
  amdenterpriseai/aim-mistralai-mistral-large-3-675b-instruct-2512:0.10.0
```
...
docker run --rm \
  ...
  amdenterpriseai/aim-mistralai-mistral-large-3-675b-instruct-2512:0.10.0 \
  download-to-cache --model-id mistralai/Mistral-Large-3-675B-Instruct-2512
```
...
aim_id: mistralai/Mistral-Large-3-675B-Instruct-2512
