...
This AIM allows to deploy ibm-granite/granite-3.3-2b-instruct with a tailored set of profiles.

* Model name: ibm-granite/granite-3.3-2b-instruct
* Description: 2B parameter instruction-tuned language model with 128K context length and improved reasoning capabilities.
* Capabilities:
  * text-generation
  * chat
  * reasoning
