...
This AIM allows to deploy mistralai/Mistral-Small-3.2-24B-Instruct-2506 with a tailored set of profiles.

* Model name: mistralai/Mistral-Small-3.2-24B-Instruct-2506
* Description: 24B parameter instruction-tuned language model with vision and function calling capabilities.
* Capabilities:
  * text-generation
  * chat
