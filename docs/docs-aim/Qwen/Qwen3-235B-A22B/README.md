...
This AIM allows to deploy Qwen/Qwen3-235B-A22B with a tailored set of profiles.

* Model name: Qwen/Qwen3-235B-A22B
* Description: 235B parameter MoE language model with 22B active parameters and dual thinking modes.
* Capabilities:
  * text-generation
  * chat
  * conversational
