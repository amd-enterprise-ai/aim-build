...
This AIM allows to deploy Qwen/Qwen3-Coder-Next with a tailored set of profiles.

* Model name: Qwen/Qwen3-Coder-Next
* Description: 80B parameter MoE coding agent model with 3B active parameters and hybrid attention architecture.
* Capabilities:
  * text-generation
  * coding
  * chat
...
|vllm-mi300x-bf16-tp1-throughput|MI300X|bf16|vllm|1|throughput|unoptimized|True|
...
|vllm-mi350x-mxfp4-tp1-latency|MI350X|fp4|vllm|1|latency|unoptimized|True|
|vllm-mi350x-mxfp4-tp1-throughput|MI350X|fp4|vllm|1|throughput|unoptimized|True|
...
|vllm-mi355x-mxfp4-tp1-latency|MI355X|fp4|vllm|1|latency|unoptimized|True|
|vllm-mi355x-mxfp4-tp1-throughput|MI355X|fp4|vllm|1|throughput|unoptimized|True|
