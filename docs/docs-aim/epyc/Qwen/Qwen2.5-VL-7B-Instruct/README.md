...
This AIM allows to deploy Qwen/Qwen2.5-VL-7B-Instruct with a tailored set of profiles.

* Model name: Qwen/Qwen2.5-VL-7B-Instruct
* Description: 7B parameter vision-language model optimized for CPU inference on AMD EPYC.
* Capabilities:
  * text-generation
  * image-text-to-text
  * vision-language
