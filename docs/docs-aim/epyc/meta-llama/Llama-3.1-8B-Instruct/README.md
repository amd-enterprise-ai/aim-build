...
This AIM allows to deploy meta-llama/Llama-3.1-8B-Instruct with a tailored set of profiles.

* Model name: meta-llama/Llama-3.1-8B-Instruct
* Description: Multilingual 8B parameter instruction-tuned language model for dialogue use cases.
* Capabilities:
  * text-generation
  * chat
  * instruction
...
This AIM can be used in accordance with the following licenses: llama3.1, MIT, AMD EPYC CONTAINER LICENSE AGREEMENT.
