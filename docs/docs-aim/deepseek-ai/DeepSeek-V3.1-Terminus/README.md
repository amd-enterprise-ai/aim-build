...
This AIM allows to deploy deepseek-ai/DeepSeek-V3.1-Terminus with a tailored set of profiles.

* Model name: deepseek-ai/DeepSeek-V3.1-Terminus
* Description: 671B parameter MoE model with 37B active parameters, refined for language consistency and agent tasks.
* Capabilities:
  * text-generation
  * chat
