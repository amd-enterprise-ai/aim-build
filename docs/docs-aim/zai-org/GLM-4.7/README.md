...
This AIM allows to deploy zai-org/GLM-4.7 with a tailored set of profiles.

* Model name: zai-org/GLM-4.7
* Description: GLM-4.7 is a large language model with multi-turn conversation, tool use, and reasoning capabilities.
* Capabilities:
  * text-generation
  * chat
  * reasoning
...
|vllm-mi300x-fp8-tp2-latency|MI300X|fp8|vllm|2|latency|optimized|False|
...
|vllm-mi325x-fp8-tp4-latency|MI325X|fp8|vllm|4|latency|unoptimized|True|
|vllm-mi325x-fp8-tp4-throughput|MI325X|fp8|vllm|4|throughput|unoptimized|True|
...
|vllm-mi350x-bf16-tp4-throughput|MI350X|bf16|vllm|4|throughput|optimized|False|
...
|vllm-mi350x-fp8-tp2-throughput|MI350X|fp8|vllm|2|throughput|optimized|False|
|vllm-mi350x-fp8-tp4-latency|MI350X|fp8|vllm|4|latency|optimized|False|
|vllm-mi350x-fp8-tp4-throughput|MI350X|fp8|vllm|4|throughput|optimized|False|
...
|vllm-mi350x-mxfp4-tp2-latency|MI350X|fp4|vllm|2|latency|optimized|False|
...
|vllm-mi355x-bf16-tp4-throughput|MI355X|bf16|vllm|4|throughput|optimized|False|
...
|vllm-mi355x-fp8-tp2-throughput|MI355X|fp8|vllm|2|throughput|optimized|False|
|vllm-mi355x-fp8-tp4-latency|MI355X|fp8|vllm|4|latency|optimized|False|
|vllm-mi355x-fp8-tp4-throughput|MI355X|fp8|vllm|4|throughput|optimized|False|
...
|vllm-mi355x-mxfp4-tp2-latency|MI355X|fp4|vllm|2|latency|optimized|False|
