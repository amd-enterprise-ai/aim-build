...
This AIM allows to deploy google/gemma-3n-E4B-it with a tailored set of profiles.

* Model name: google/gemma-3n-E4B-it
* Description: Gemma 3n E4B IT is a gated multimodal instruction-tuned model supporting text, image, video, and audio inputs.
* Capabilities:
  * text-generation
  * image-text-to-text
  * audio-text-to-text
...
|-------|-------------------|---------|------|---------|------|----|-------------|
|vllm-r9700-bf16-tp1-latency|R9700|bf16|vllm|1|latency|preview|False|
|vllm-r9700-bf16-tp1-throughput|R9700|bf16|vllm|1|throughput|preview|False|
|vllm-w7900-bf16-tp1-latency|W7900|bf16|vllm|1|latency|preview|False|
|vllm-w7900-bf16-tp1-throughput|W7900|bf16|vllm|1|throughput|preview|False|
